...
function generateFortune(zodiacIndex) {
  ...
  var seed = daySeed * 13 + zodiacIndex * 7;

  var r = function(offset) { return seededRandom(seed + offset); };
  var pick = function(arr, offset) { return arr[Math.floor(r(offset) * arr.length)]; };
  var stars = function(offset) { return Math.floor(r(offset) * 3) + 3; }; // 3-5

  var lucky = pick(luckyColors, 100);
  var luckyNum = Math.floor(r(200) * 9) + 1;
  var matchIdx = Math.floor(r(300) * 12);
