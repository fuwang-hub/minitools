...
// 六合
var liuHe = { 0:1, 1:0, 2:11, 11:2, 3:10, 10:3, 4:9, 9:4, 5:8, 8:5, 6:7, 7:6 };
// 三合
var sanHe = { 0:[0,4,8], 1:[1,5,9], 2:[2,6,10], 3:[3,7,11] };
// 六冲
var liuChong = { 0:6, 6:0, 1:7, 7:1, 2:8, 8:2, 3:9, 9:3, 4:10, 10:4, 5:11, 11:5 };
...
Page({
  onLoad: function() {
    ...
    analytics.startStay('zodiac-match');
  ...
  selectZodiac: function(e) {
    ...
    if (this.data.selecting === 1) {
      ...
      var match = getMatch(this.data.z1, index);
      this.setData({ showResult: true, result: match });
    }
  },

  restart: function() { this.setData({ z1: -1, z2: -1, selecting: 1, showResult: false, result: null }); },

  onHide: function() { analytics.endStay('zodiac-match'); },


  onUnload: function() { analytics.endStay('zodiac-match'); },



  onShareAppMessage: function() {
    var z1 = this.data.z1; var z2 = this.data.z2; var result = this.data.result;
